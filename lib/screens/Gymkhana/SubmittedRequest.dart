                ...
                if (snapshot.connectionState == ConnectionState.waiting) {
                  ...
                  eventRequests = snapshot.data!.map((eventData) {
                    return EventRequest(
                      ...
                      club: eventData['club'],
                      startTime: TimeOfDay.now(), // You may need to adjust this
                      endTime: TimeOfDay.now(), // You may need to adjust this
                  ...
                  return DataTable(
                    ...
                    rows: eventRequests.map((request) {
                      String eventId =
                          '${request.id}_${request.eventName}_${request.inCharge}_${request.date}_${request.club}_${request.venue}';
